...
import 'allocation.pb.dart' as $0;
export 'allocation.pb.dart';

class AllocationServiceClient extends $grpc.Client {
  static final _$allocate =
      $grpc.ClientMethod<$0.AllocationRequest, $0.AllocationResponse>(
          '/allocation.AllocationService/Allocate',
          ($0.AllocationRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.AllocationResponse.fromBuffer(value));

  AllocationServiceClient($grpc.ClientChannel channel,
...
abstract class AllocationClientServiceBase extends $grpc.Service {
  $core.String get $name => 'allocation.AllocationService';
