...
const JSONSchema$json = const {
  ...
  '2': const [
    ...
    const {'1': 'field_configuration', '3': 1001, '4': 1, '5': 11, '6': '.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.FieldConfiguration', '10': 'fieldConfiguration'},
    const {'1': 'extensions', '3': 48, '4': 3, '5': 11, '6': '.grpc.gateway.protoc_gen_openapiv2.options.JSONSchema.ExtensionsEntry', '10': 'extensions'},
  ],
  '3': const [JSONSchema_FieldConfiguration$json, JSONSchema_ExtensionsEntry$json],
...
const JSONSchema_FieldConfiguration$json = const {
  ...
  '2': const [
    const {'1': 'path_param_name', '3': 47, '4': 1, '5': 9, '10': 'pathParamName'},
  ],
};
...
final $typed_data.Uint8List jSONSchemaDescriptor = $convert.base64Decode('');
