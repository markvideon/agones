...
final $typed_data.Uint8List durationDescriptor = $convert.base64Decode('CghEdXJhdGlvbhIYCgdzZWNvbmRzGAEgASgDUgdzZWNvbmRz');
@$core.Deprecated('Use gameServerDescriptor instead')
const GameServer$json = const {
  '1': 'GameServer',
  '2': const [
    const {'1': 'object_meta', '3': 1, '4': 1, '5': 11, '6': '.agones.dev.sdk.GameServer.ObjectMeta', '10': 'objectMeta'},
    const {'1': 'spec', '3': 2, '4': 1, '5': 11, '6': '.agones.dev.sdk.GameServer.Spec', '10': 'spec'},
    const {'1': 'status', '3': 3, '4': 1, '5': 11, '6': '.agones.dev.sdk.GameServer.Status', '10': 'status'},
  ],
  '3': const [GameServer_ObjectMeta$json, GameServer_Spec$json, GameServer_Status$json],
};
...
const GameServer_ObjectMeta$json = const {
  ...
  '2': const [
    ...
    const {'1': 'resource_version', '3': 4, '4': 1, '5': 9, '10': 'resourceVersion'},
    const {'1': 'generation', '3': 5, '4': 1, '5': 3, '10': 'generation'},
    const {'1': 'creation_timestamp', '3': 6, '4': 1, '5': 3, '10': 'creationTimestamp'},
    const {'1': 'deletion_timestamp', '3': 7, '4': 1, '5': 3, '10': 'deletionTimestamp'},
    const {'1': 'annotations', '3': 8, '4': 3, '5': 11, '6': '.agones.dev.sdk.GameServer.ObjectMeta.AnnotationsEntry', '10': 'annotations'},
    const {'1': 'labels', '3': 9, '4': 3, '5': 11, '6': '.agones.dev.sdk.GameServer.ObjectMeta.LabelsEntry', '10': 'labels'},
  ],
  '3': const [GameServer_ObjectMeta_AnnotationsEntry$json, GameServer_ObjectMeta_LabelsEntry$json],
};
...
const GameServer_Spec$json = const {
  '1': 'Spec',
  '2': const [
    const {'1': 'health', '3': 1, '4': 1, '5': 11, '6': '.agones.dev.sdk.GameServer.Spec.Health', '10': 'health'},
  ],
...
const GameServer_Spec_Health$json = const {
  '1': 'Health',
  '2': const [
    const {'1': 'disabled', '3': 1, '4': 1, '5': 8, '8': const {}, '10': 'disabled'},
    const {'1': 'period_seconds', '3': 2, '4': 1, '5': 5, '10': 'periodSeconds'},
    const {'1': 'failure_threshold', '3': 3, '4': 1, '5': 5, '10': 'failureThreshold'},
    const {'1': 'initial_delay_seconds', '3': 4, '4': 1, '5': 5, '10': 'initialDelaySeconds'},
  ],
};
...
const GameServer_Status$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ports', '3': 3, '4': 3, '5': 11, '6': '.agones.dev.sdk.GameServer.Status.Port', '10': 'ports'},
    const {'1': 'players', '3': 4, '4': 1, '5': 11, '6': '.agones.dev.sdk.GameServer.Status.PlayerStatus', '10': 'players'},
  ],
